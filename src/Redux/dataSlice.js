...
const dataSlice = createSlice({
	...
	reducers: {
		...
		getPlan(state, action) {
			const {gender, age, height, weight, bodytype, workoutex } = action.payload;
...
export const { addAge, addName, addGender, addHeight, addWeight, addBodytype, addWorkoutex, getPlan } = dataSlice.actions;
